...
// should default to next_available_order
 ...
 */
BOOST_AUTO_TEST_CASE( create_powerset2_append) {
    powerset_type ps;
 ...
 * Verify allocated size
 */
BOOST_AUTO_TEST_CASE( create_powerset2_add) {
 ...
 * Verify allocated size
 */
BOOST_AUTO_TEST_CASE( create_powerset2_width ) {
    powerset_type ps;
 ...
 * Verify that each new element is assigned to expected index
 */
BOOST_AUTO_TEST_CASE( create_powerset2_find_or_create_unique ) {
    powerset_type ps;
 ...
 * Verify that each new element is assigned to expected index
 */
BOOST_AUTO_TEST_CASE( create_powerset2_find_or_create_order_collision ) {
    powerset_type ps;
 ...
 */
BOOST_AUTO_TEST_CASE( create_powerset2_subset ) {
    powerset_type ps;
 ...
 *
 */
BOOST_AUTO_TEST_CASE( create_powerset2_prunespace ) {
    powerset_type ps;
 ...
 *
 */
BOOST_AUTO_TEST_CASE( create_powerset2_prunespace2 ) {
    powerset_type ps;
