...
#ifndef CLOTHO_STRINGS_HPP_
#define CLOTHO_STRINGS_HPP_
...
extern const std::string REC_BLOCK_K;
extern const std::string RHO_K;

extern const std::string MAX_K;
extern const std::string MEAN_K;
extern const std::string SIGMA_K;
