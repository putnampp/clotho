...
#ifndef CLOTHO_ASSORTATIVE_SELECTION_GENERATOR_HPP_
#define CLOTHO_ASSORTATIVE_SELECTION_GENERATOR_HPP_
...
template < class T >
struct assortative_selection {};

template < class RNG, class GeneticSpaceType >
class SelectionGenerator< RNG, assortative_selection< GeneticSpaceType > > {
public:
    ...
    SelectionGenerator( random_engine_type * rng, boost::property_tree::ptree & config ) :
        m_rand( rng )
    {
        std::cout << "assortative selection" << std::endl;
    }
...
#endif  // CLOTHO_ASSORTATIVE_SELECTION_GENERATOR_HPP_
