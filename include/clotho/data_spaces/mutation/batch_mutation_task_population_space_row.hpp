...
#ifndef CLOTHO_BATCH_MUTATION_TASK_POPULATION_SPACE_ROW_HPP_
#define CLOTHO_BATCH_MUTATION_TASK_POPULATION_SPACE_ROW_HPP_
...
class BatchMutationTask< RNG, population_space_row< BlockType, WeightType >, AlleleSpaceType, TraitSpaceType, SizeType > : public task {
public:

    typedef BatchMutationTask< RNG, population_space_row< BlockType, WeightType >, AlleleSpaceType, TraitSpaceType, SizeType > self_type;

    typedef RNG random_engine_type;
    typedef population_space_row< BlockType, WeightType > population_space_type;
...
#endif  // CLOTHO_BATCH_MUTATION_TASK_POPULATION_SPACE_ROW_HPP_
