...
#ifndef CLOTHO_FREE_SPACE_MT_POPULATION_SPACE_HPP_
#define CLOTHO_FREE_SPACE_MT_POPULATION_SPACE_HPP_
...
class FreeSpaceAnalyzerMT < population_space< BlockType, WeightType >, SizeType > : public free_space_details< SizeType > {
public:
    ...
    void operator()( space_type * ss, PoolType & pool ) {
        ...
        memset( destF, 255, B * sizeof(block_type) );
        memset( destV, 0, B * sizeof(block_type) );
...
#endif  // CLOTHO_FREE_SPACE_MT_POPULATION_SPACE_HPP_
