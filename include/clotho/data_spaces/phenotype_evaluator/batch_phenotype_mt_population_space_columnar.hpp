...
#ifndef CLOTHO_BATCH_PHENOTYPE_MT_POPULATION_SPACE_COLUMNAR_HPP_
#define CLOTHO_BATCH_PHENOTYPE_MT_POPULATION_SPACE_COLUMNAR_HPP_

#include "clotho/data_spaces/population_space/population_space_columnar.hpp"

#include "clotho/data_spaces/phenotype_evaluator/batch_phenotype_task_population_space_columnar.hpp"
...
class BatchPhenotypeMT< population_space_columnar< BlockType, WeightType >, TraitSpaceType > {
public:

    typedef BatchPhenotypeMT< population_space_columnar< BlockType, WeightType >, TraitSpaceType > self_type;
...
template < class BlockType, class WeightType, class TraitSpaceType >
struct state_getter< clotho::genetics::BatchPhenotypeMT< clotho::genetics::population_space_columnar<BlockType, WeightType>, TraitSpaceType > >  {
    typedef clotho::genetics::BatchPhenotypeMT< clotho::genetics::population_space_columnar<BlockType, WeightType>, TraitSpaceType > object_type;
...
#endif  // CLOTHO_BATCH_PHENOTYPE_MT_POPULATION_SPACE_COLUMNAR_HPP_
