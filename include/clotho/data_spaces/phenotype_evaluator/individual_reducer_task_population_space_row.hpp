...
#ifndef CLOTHO_INDIVIDUAL_REDUCER_ROW_HPP_
#define CLOTHO_INDIVIDUAL_REDUCER_ROW_HPP_
...
class individual_reducer_task< population_space_row< BlockType, WeightType >, PhenotypeSpaceType > : public task {
public:
    typedef individual_reducer_task< population_space_row< BlockType, WeightType >, PhenotypeSpaceType >                    self_type;
...
#endif  // CLOTHO_INDIVIDUAL_REDUCER_ROW_HPP_
